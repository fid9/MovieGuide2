...
public class  MovieResponseResults {
    ...
    public MovieResponseResults(int vote_count, int id, boolean video, float vote_average, String title, String poster_path, String original_language, String original_title, List<Integer> genre_ids, String backdoor_path, boolean adult, String overview, String release_date) {
