    ...
    public void onBindViewHolder(@NonNull final MovieVideosViewHolder movieVideosViewHolder, int i) {
        ...
        movieVideosViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ActivityOptionsCompat compat = ActivityOptionsCompat.makeSceneTransitionAnimation(activity,movieVideosViewHolder.thumbnailView, Objects.requireNonNull(ViewCompat.getTransitionName(movieVideosViewHolder.thumbnailView)));
